...
set ns [new Simulator -multicast on] ;# we write it in exam
...
set group [Node allocaddr] ;# we write it in exam
#===================================
#        Nodes Definition        
#===================================
#Create 5 nodes
...
set mproto DM  ;#we write it in exam
set mrthandle [$ns mrtproto $mproto] ;# we write it in exam
...
#        Agents Definition        
#===================================
set udp0 [new Agent/UDP]    ;#we write it in exam
$ns attach-agent $n0 $udp0
$udp0 set dst_addr_ $group #we write it in exam
